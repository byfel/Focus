...
#
# SQLite: simples, sem serviço extra pra manter no ar, suficiente
# pro volume de uso de uma equipe pequena. Se um dia isso crescer
# muito, migrar pra Postgres é o próximo passo natural — mas não
# há necessidade disso agora.
# ============================================================
CONVERSATIONS_DB_PATH = os.getenv(
    "RAG_CONVERSATIONS_DB", "/opt/ai/rag/data/conversations.db"
)
CONVERSATION_TITLE_MAX_CHARS = 80
# Usado futuramente pela limpeza automática (conversas com
# updated_at mais antigo que N dias). Ainda não há job rodando
# isso — é só a constante já pronta pra quando implementarmos.
CONVERSATION_RETENTION_DAYS = int(os.getenv("RAG_CONVERSATION_RETENTION_DAYS", "10"))
